...
this.bg.setOrigin(0, 0);
    ...
    this.bluebottle = this.physics.add.sprite(1300, 644, 'bluebottle');
    //this.apple = this.physics.add.sprite(1100, 600, 'apple');
    this.toiletpaper = this.physics.add.sprite(850, 600, 'toiletpaper');
    this.oil = this.physics.add.sprite(580, 600, 'oil');
    this.apple = this.physics.add.sprite(1000, 620, 'apple');
    ...
    this.yellowText = this.add.text(20, 40, 'Waste 0', {
        fontSize: '30px',
        fill: '#ffffff'
    });
    ...
    this.add.text(1500,40, 'Level 5', { font: '30px Courier', fill: '#ffffff' });
...
dropyellow(player) {
 ...
 dropgreen(player) {
    if (this.collectbluebottle) {
        console.log('drobluebottle')
...
update() {
 ...
 // use the original sprite looking to the right
    ...
    if ( this.paperCount > 3 ) {
        console.log('Collected 1 star, jump to last');
