class star_level4 extends Phaser.Scene {

    constructor ()
    {
        super({ key: 'star_level4' });
    }

    preload() {
        this.load.image('star_level4','assets/star_level4.png');
    }

    create () {

        this.add.image(0, 0, 'star_level4').setOrigin(0, 0);
        
        //this.add.text(60,40, 'Lim Jia Yee CNMT2019', { font: '20px Courier', fill: '#ffffff' });

        console.log("star_level4");
        ...
        console.log("Spacebar pressed, goto level5");
        this.scene.stop("star_level4");
        this.scene.start("level5");
        //this.scene.start("level1");
        }, this );

        this.input.once('pointerdown', function(){
        console.log("pointer pressed, goto level5");
        this.scene.stop("star_level4");
        this.scene.start("level5");
        }, this );    
