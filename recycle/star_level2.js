class star_level2 extends Phaser.Scene {

    constructor ()
    {
        super({ key: 'star_level2' });
    }

    preload() {
        this.load.image('star_level2','assets/star_level2.png');
    }

    create () {

        this.add.image(0, 0, 'star_level2').setOrigin(0, 0);
        
        //this.add.text(60,40, 'Lim Jia Yee CNMT2019', { font: '20px Courier', fill: '#ffffff' });

        console.log("star_level2");
        ...
        this.scene.stop("star_level2");
        this.scene.start("level3");
        //this.scene.start("level1");
        }, this );

        this.input.once('pointerdown', function(){
        console.log("pointer pressed, goto level3");
        this.scene.stop("star_level2");
        this.scene.start("level3");
        }, this );    
