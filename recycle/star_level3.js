class star_level3 extends Phaser.Scene {

    constructor ()
    {
        super({ key: 'star_level3' });
    }

    preload() {
        this.load.image('star_level3','assets/star_level3.png');
    }

    create () {

        this.add.image(0, 0, 'star_level3').setOrigin(0, 0);
        
        //this.add.text(60,40, 'Lim Jia Yee CNMT2019', { font: '20px Courier', fill: '#ffffff' });

        console.log("star_level3");
        ...
        this.scene.stop("star_level3");
        this.scene.start("level4");
        //this.scene.start("level1");
        }, this );

        this.input.once('pointerdown', function(){
        console.log("pointer pressed, goto level4");
        this.scene.stop("star_level3");
        this.scene.start("level4");
        }, this );    
